...
const DashboardPage: React.FC = () => {
    ...
    return (
        ...
        <img src={logo} alt="Logo" className="logo"/>
            <br /><br /><br />
            <div className="header-text">Welcome {broadcaster.upn}</div>
        <div className="header-right">
            <div className="icon"><svg id="search-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M 9 2 C 5.1458514 2 2 5.1458514 2 9 C 2 12.854149 5.1458514 16 9 16 C 10.747998 16 12.345009 15.348024 13.574219 14.28125 L 14 14.707031 L 14 16 L 20 22 L 22 20 L 16 14 L 14.707031 14 L 14.28125 13.574219 C 15.348024 12.345009 16 10.747998 16 9 C 16 5.1458514 12.854149 2 9 2 z M 9 4 C 11.773268 4 14 6.2267316 14 9 C 14 11.773268 11.773268 14 9 14 C 6.2267316 14 4 11.773268 4 9 C 4 6.2267316 6.2267316 4 9 4 z"></path>
            </svg>
            </div>
            <div className="icon">
            ...
            <img src={nas} alt="Profile Picture" className="profile-pic"/>
        </div>
    </header>
    <div id="search-popup">
        <input type="text" id="search-input" placeholder="Search for members..."/>
    ...
    <section className="sidebar">
        <div className="sidebarmain">
            ...
            <div className="profile-container">
                <img src={nas} alt="User Profile" className="profile-image" />
                <h3 className="user-name">Bola Ahmed</h3>
             </div>
        
            <ul className="links-list">
                <li onClick={() => setCurrentPage('profile')}><a className="link-item"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-people-fill" viewBox="0 0 16 16"><path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.3 6.3 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/></svg> Profile</a></li>
                <li onClick={() => setCurrentPage('video')}><a className="link-item"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-play-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/><path d="M6.271 5.055a.5.5 0 0 1 .52.038l3.5 2.5a.5.5 0 0 1 0 .814l-3.5 2.5A.5.5 0 0 1 6 10.5v-5a.5.5 0 0 1 .271-.445"/></svg>Videos</a></li>
            ...
            <div className="footer-link">
                <a onClick={() => logout()} href="" className="link-item"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-power" viewBox="0 0 16 16"><path d="M7.5 1v7h1V1z"/><path d="M3 8.812a5 5 0 0 1 2.578-4.375l-.485-.874A6 6 0 1 0 11 3.616l-.501.865A5 5 0 1 1 3 8.812"/></svg>Log Out</a>
            </div>
        </div>
    </section>
    {/* Main content */}
