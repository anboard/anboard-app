...
const DashboardPage: React.FC = () => {
    ...
    if (error) return <p>Error: {error}</p>;
            ...
            const searchPopup = document.getElementById("searchpopupID");
            ...
            function searchMember() {
                const searchInput = (document.getElementById("searchinputID") as HTMLInputElement).value.toLowerCase();
    ...
    <div className={styles.searchpopup}>
        <input type="text" className={styles.searchinput} placeholder="Search for members..."/>
