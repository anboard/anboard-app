  ...
  const searchMember = () => {
    ...
    const foundMember = members.find(
      (member) =>
        ...
        member.id.includes(searchInput)
    );
      ...
      <section className={styles.sidebar}>
        <div className={styles.sidebarmain}>
          ...
          <ul className={styles.linkslist}>
            <li onClick={() => setCurrentPage("profile")}>
              <a className={styles.linkitem}>
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className={`bi bi-people-fill${styles.customanbicon}`}
                  viewBox="0 0 16 16"
                >
            ...
            <li onClick={() => setCurrentPage("video")}>
              <a className={styles.linkitem}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                  fill="currentColor"
                  className={`bi bi-play-circle${styles.customanbicon}`}
                  viewBox="0 0 16 16"
                >
            ...
            <li onClick={() => setCurrentPage("picture")}>
              <a className={styles.linkitem}>
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className={`bi bi-image${styles.customanbicon}`}
                  viewBox="0 0 16 16"
                >
            ...
            <li onClick={() => setCurrentPage("audio")}>
              <a className={styles.linkitem}>
                <svg
          ...
          <div className={styles.footerlink}>
            <a onClick={() => logout()} href="" className={styles.linkitem}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                fill="currentColor"
                className={`bi bi-power${styles.customanbicon}`}
                viewBox="0 0 16 16"
              >
